			...
			<div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10'>
				<div className='h-full flex flex-col justify-center container mx-auto text-center xl:pt-40 xl:text-left '>
					...
					>
						...
						Accusantium voluptates vel explicabo suscipit voluptatum,
						exercitationem nisi repellat. Quis optio vero sit vitae odio quia
						hic, sapiente nisi deserunt. Neque, dolore?
					</motion.p>
					{/* btn */}
